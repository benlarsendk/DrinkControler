...
int DatabaseIF::createDrink(Drink & inDrink)
{
    if (!checkName(DRINK,inDrink.name))
    {
        ...
        QString bindQuery = "INSERT INTO Drinks ([Navn],[cont_1_name],[cont_1_amt],[cont_2_name],[cont_2_amt],[cont_3_name],[cont_3_amt],[cont_4_name],[cont_4_amt],[cont_5_name],[cont_5_amt]) VALUES(:name,:cname1,:camt1,:cname2,:camt2,:cname3,:camt3,:cname4,:camt4,:cname5,:camt5)";
        QSqlQuery query;
